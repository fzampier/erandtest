...
- Didactic trajectory examples are now regenerated by a standalone fixed-seed
  script that selects representative panels for the manuscript figures.
...
- `R/simulations/`
  ...
  - `manuscript_trajectory_examples.R`: curated trajectory examples for
    e-RTb, e-RTe, e-RTc, and e-RTs.
...
- Curated manuscript trajectory examples: base seed `20260503`.
